...
public class PlayerController : MonoBehaviour
{
    ...
    [SerializeField] float stopDelay = 0.05f; // Tiempo que debe pasar sin moverse para detener animación
    ...
    void MovePlayerInput()
    {
        ...
        if (moveX != 0)
        {
            lastMoveTime = Time.time; // Actualiza el tiempo del último movimiento
